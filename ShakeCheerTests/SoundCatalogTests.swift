...
final class SoundCatalogTests: XCTestCase {
    ...
    func testSustainedPlaybackMetadata() {
        ...
        XCTAssertEqual(SoundCatalog.drum.loopEndTime, 5.75)
        XCTAssertEqual(SoundCatalog.stadiumHorn.loopEndTime, 8.10)
        ...
        XCTAssertEqual(SoundCatalog.sadTrumpet.loopEndTime, 3.75)
        XCTAssertEqual(SoundCatalog.sadTrumpet.volumeMultiplier, 1.15)
        XCTAssertEqual(SoundCatalog.refereeWhistle.playbackMode, .impact)
        XCTAssertEqual(SoundCatalog.coin.playbackMode, .impact)
        XCTAssertEqual(SoundCatalog.levelUp.playbackMode, .impact)
        ...
        XCTAssertEqual(SoundCatalog.partyBlower.playbackMode, .impact)
