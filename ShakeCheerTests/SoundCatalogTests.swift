...
final class SoundCatalogTests: XCTestCase {
    ...
    func testSustainedPlaybackMetadata() {
        ...
        XCTAssertEqual(SoundCatalog.drum.loopEndTime, 4.20)
        ...
        XCTAssertEqual(SoundCatalog.boo.loopEndTime, 2.15)
        ...
        XCTAssertEqual(SoundCatalog.sadTrumpet.loopEndTime, 7.35)
